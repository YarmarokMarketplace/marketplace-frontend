...
import { productFilterGoodtypeAction } from '../../../../redux/products/reducer';
...
const GoodtypeFilter: React.FC<CategoryFilterProps> = ({
  ...
  useEffect(() => {
    ...
    if (storedFilterByType) {
      ...
      storedFilterByType.includes('new')
        ? setIsCheckedNew(true)
        : setIsCheckedNew(false);
      storedFilterByType.includes('used')
        ? setIsCheckedUsed(true)
