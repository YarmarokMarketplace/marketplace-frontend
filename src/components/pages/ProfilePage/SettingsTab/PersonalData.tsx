...
const PersonalData = () => {
  ...
  const onSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    patronymic
      ? form.append('patronymic', patronymic)
      : form.append('patronymic', ' ');
  ...
  return (
    <>
      <form onSubmit={onSubmit}>
        <HeaderTypography>Персональні дані</HeaderTypography>
        ...
        >
          ...
          <InputWrapper>
            <StyledFormLabel>Прізвище</StyledFormLabel>
            <Controller
              control={control}
              name='lastname'
          ...
          <InputWrapper>
            <StyledFormLabel>По батькові</StyledFormLabel>
            <Controller
              control={control}
              name='patronymic'
        ...
        <HeaderTypography>Аватарка</HeaderTypography>
        <DescriptionTypography variant='body2'>
        ...
        >
            ...
            <UploadButton
              sx={{
                background: `center / contain no-repeat ${
                  localUser.avatarURL instanceof File
          ...
          <Stack direction='row' spacing={0.5}>
            ...
            <IconButton aria-label='delete' onClick={deleteBtnMessage}>
              <DeleteOutlineOutlinedIcon />
            </IconButton>
          </Stack>
        </Stack>

        <HeaderTypography>Контакти</HeaderTypography>
        <DescriptionTypography variant='body2'>
